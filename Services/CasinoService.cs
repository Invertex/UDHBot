        ...
        public (string imagePath, string reply) PlaySlotMachine(IUser user, int amount)
        {
            ...
            if (random <= 50) //Lose
            {
                return (Settings.GetServerRootPath() + "/casino/lose.png",
                    "You're in a daze staring at the blinking machine rolling away at near the speed of light. Sadly, it stops without any matching icons. You feel your luck is near and that you should try again.");
            }
            else if (random <= 70) //Apple, 2x
            {
                ...
                return (Settings.GetServerRootPath() + "/casino/apple_nearmiss.png",
                    "The machine blinks and spins away with a captivating sound. As it begins to slow down, you see tasty apples begin to lock. One, two... sadly the third didn't make it. You weep silently and decide that your luck will be better next time. You should try again !");
            }
            ...
            else if (random <= 95) //Donut, 15x
            {
                if (Slot(25))
                {
                    ...
                    return (Settings.GetServerRootPath() + "/casino/donut_nearmiss.png",
            ...
            else //Jackpot
            {
                if (Slot(10))
                {
                    ...
                    return (Settings.GetServerRootPath() + "/casino/jackpot_nearmiss.png",
