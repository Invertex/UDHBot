...
namespace DiscordBot.Extensions
{
    ...
    {
        public static Task DeleteAfterTime(this IDeletable message, int seconds = 0, int minutes = 0, int hours = 0, int days = 0) => message.DeleteAfterTimeSpan(new TimeSpan(seconds, minutes, hours, days));
