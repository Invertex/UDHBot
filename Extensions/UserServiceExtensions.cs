...
namespace DiscordBot.Extensions
{
    ...
    #region Cooldown related
        ...
        public static void AddCooldown(this Dictionary<ulong, DateTime> cooldowns, ulong userId, int seconds = 0, int minutes = 0, int hours = 0, int days = 0, bool ignoreExisting = false)
        {
        ...
        {
            cooldowns.AddCooldown(userId, days:(enabled) ? Int32.MaxValue : 0, ignoreExisting: true);
        }
        ...
        {
            if(!cooldowns.HasUser(userId)) { return 0; }
