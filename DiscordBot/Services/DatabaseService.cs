...
namespace DiscordBot.Services
{
    public class DatabaseService
    {
        ...
        public DatabaseService(ILoggingService logging, Settings.Deserialized.Settings settings)
        {
            ...
            {
                LoggingService.LogToConsole($"DatabaseService: Table 'users' does not exist, attempting to generate table.", Severity.Warning);
                c.ExecuteSql(
                ...
                LoggingService.LogToConsole($"DatabaseService: Table 'users' generated without errors.", Severity.Pass);
            }
